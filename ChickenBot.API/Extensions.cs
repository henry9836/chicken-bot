...
namespace ChickenBot.API
{
    public static class Extensions
    {
        ...
        /// <param name="emojiName">Emoji name</param>
        /// <param name="ctx">The message to react to</param>
        public static DiscordEmoji? TryGetEmoji(this CommandContext ctx, string emojiName)
        {
        ...
        /// <summary>
        /// Attempts to delete a message, and throws no error if it fails
        /// </summary>
        /// <remarks>
        /// Useful to run clean-up on commands which may have been already deleted
        /// </remarks>
